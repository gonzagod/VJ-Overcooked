			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = texture(_ColorBuffer, vs_TEXCOORD1.xy);
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat1 = texture(_ColorBuffer, vs_TEXCOORD1.xy);
					    SV_Target0 = vec4(_Intensity) * u_xlat0 + u_xlat1;
					    return;
					}"
				}
				SubProgram "d3d11_9x " {
		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					{
					    u_xlat0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat1 = texture(_ColorBuffer, vs_TEXCOORD0.xy);
		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_ColorBuffer, vs_TEXCOORD0.xy);
