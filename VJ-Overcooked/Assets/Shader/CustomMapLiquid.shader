			...
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.x = u_xlat1.x / u_xlat6;
					    u_xlat0.x = u_xlat0.x + 1.0;
					    u_xlat0.x = u_xlat0.x * 0.5;
					    u_xlat0.x = u_xlat0.x * u_xlat0.x;
					    u_xlat1 = (-_Color1) + _Color2;
					    vs_COLOR0 = u_xlat0.xxxx * u_xlat1 + _Color1;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    vs_TEXCOORD3.xyz = max(u_xlat2.xyz, vec3(0.0, 0.0, 0.0));
					    u_xlat2.xz = u_xlat0.xw * vec2(0.5, 0.5);
					    u_xlat16 = u_xlat0.y * _ProjectionParams.x;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3.xyz = max(u_xlat3.xyz, vec3(0.0, 0.0, 0.0));
					    vs_TEXCOORD3.xyz = u_xlat2.xyz + u_xlat3.xyz;
					    vs_TEXCOORD1.xyz = u_xlat1.xyz;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat4.xyz = max(u_xlat4.xyz, vec3(0.0, 0.0, 0.0));
					    vs_TEXCOORD3.xyz = u_xlat3.xyz + u_xlat4.xyz;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = u_xlat2.xyz * vec3(1.05499995, 1.05499995, 1.05499995) + vec3(-0.0549999997, -0.0549999997, -0.0549999997);
					    vs_TEXCOORD3.xyz = max(u_xlat2.xyz, vec3(0.0, 0.0, 0.0));
					    u_xlat16 = u_xlat0.z / _ProjectionParams.y;
					    u_xlat16 = (-u_xlat16) + 1.0;
					    u_xlat16 = u_xlat16 * _ProjectionParams.z;
					    u_xlat16 = max(u_xlat16, 0.0);
					    vs_TEXCOORD5 = u_xlat16 * unity_FogParams.z + unity_FogParams.w;
					    gl_Position = u_xlat0;
					    vs_TEXCOORD1.xyz = u_xlat1.xyz;
					    return;
					}"
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat4.xyz = max(u_xlat4.xyz, vec3(0.0, 0.0, 0.0));
					    vs_TEXCOORD3.xyz = u_xlat3.xyz + u_xlat4.xyz;
					    u_xlat22 = u_xlat0.z / _ProjectionParams.y;
					    u_xlat22 = (-u_xlat22) + 1.0;
					    u_xlat22 = u_xlat22 * _ProjectionParams.z;
					    u_xlat22 = max(u_xlat22, 0.0);
					    vs_TEXCOORD5 = u_xlat22 * unity_FogParams.z + unity_FogParams.w;
					    gl_Position = u_xlat0;
					    vs_TEXCOORD1.xyz = u_xlat2.xyz;
					    vs_TEXCOORD2.xyz = u_xlat1.xyz;
					    return;
			...
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.x = u_xlat1.x * u_xlat1.x + (-u_xlat6);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.x = u_xlat1.x * _ProjectionParams.z;
					    u_xlat1.x = max(u_xlat1.x, 0.0);
					    vs_TEXCOORD5 = u_xlat1.x * unity_FogParams.z + unity_FogParams.w;
					    gl_Position = u_xlat0;
					    vs_TEXCOORD2.zw = u_xlat0.zw;
					    vs_TEXCOORD3 = vec4(0.0, 0.0, 0.0, 0.0);
					    return;
