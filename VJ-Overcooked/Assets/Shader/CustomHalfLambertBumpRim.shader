Shader "Custom/HalfLambertBumpRim" {
	Properties {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3 = dot(u_xlat2.xyz, _WorldSpaceLightPos0.xyz);
					    u_xlat0.x = (-u_xlat0.x) + 1.0;
					    ...
					    u_xlat3 = u_xlat3 * _WrapAmount + u_xlat1.x;
					    ...
					    u_xlat0.xyz = u_xlat2.xyz * vec3(0.5, 0.5, 0.5) + u_xlat0.xzw;
					    u_xlat0.xyz = u_xlat0.xyz + u_xlat0.xyz;
					    SV_Target0.xyz = u_xlat1.xyz * vs_TEXCOORD4.xyz + u_xlat0.xyz;
					    SV_Target0.w = 1.0;
					    return;
					}"
				}
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3.x = (-_WrapAmount) + 1.0;
					    u_xlat0.x = u_xlat0.x * _WrapAmount + u_xlat3.x;
					    u_xlat1 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat3.xyz = u_xlat1.xyz * vec3(vec3(_Brightness, _Brightness, _Brightness));
					    ...
					    u_xlat1.xyz = vec3(u_xlat9) * _RimColor.xyz;
					    ...
					    u_xlat9 = dot(u_xlat1.xyz, u_xlat1.xyz);
					    u_xlat1 = texture(_LightTexture0, vec2(u_xlat9));
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2.z = dot(vs_TEXCOORD3.xyz, u_xlat1.xyz);
					    u_xlat0.x = dot(u_xlat2.xyz, u_xlat0.xyz);
					    u_xlat0.x = u_xlat0.x * _WrapAmount + (-_WrapAmount);
					    u_xlat0.x = u_xlat0.x + 1.0;
					    u_xlat1 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat3.xyz = u_xlat1.xyz * vec3(vec3(_Brightness, _Brightness, _Brightness));
					    u_xlat3.xyz = u_xlat3.xyz * _LightColor0.xyz;
					    ...
					    u_xlat9 = dot(vec2(u_xlat9), u_xlat1.xx);
					    SV_Target0.xyz = vec3(u_xlat9) * u_xlat0.xyz;
					    SV_Target0.w = 1.0;
					    return;
					}"
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = texture(_LightTextureB0, vec2(u_xlat9));
					    u_xlat9 = dot(u_xlat2.xx, u_xlat1.ww);
					    SV_Target0.xyz = vec3(u_xlat9) * u_xlat0.xyz;
					    SV_Target0.w = 1.0;
					    return;
					}"
